...
const CollaborationPanel = React.memo(({
    ...
    if (!currentTeam) {
        return (
            <div className="flex-1 flex flex-col p-6 space-y-8 bg-[#0f1012] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <Card className="bg-white/5 border-gray-800 p-5 space-y-4 hover:bg-white/[0.07] transition-all">
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <Button className="bg-blue-600 hover:bg-blue-700 h-9 transition-all active:scale-95 px-6 font-arabic" onClick={handleCreateTeam}>
                                إنشاء
                            </Button>
                        </div>
                    </Card>
                    ...
                    <Card className="bg-white/5 border-gray-800 p-5 space-y-4 hover:bg-white/[0.07] transition-all">
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <Button className="bg-green-600 hover:bg-green-700 h-9 transition-all active:scale-95 px-6 font-arabic" onClick={handleJoinTeam}>
                                انضمام
                            </Button>
                        </div>
                    </Card>
            ...
            <div className="p-4 bg-[#1a1d21] border-t border-gray-800 space-y-3 shadow-[0_-10px_30px_rgba(0,0,0,0.8)]">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        />
                        <Button size="icon" className="h-9 w-9 bg-blue-600 hover:bg-blue-500 shadow-lg shadow-blue-500/20 transition-all active:scale-95 rounded-lg" onClick={addComment}>
                            <Send size={14} />
                        </Button>
                    </div>
                </div>
