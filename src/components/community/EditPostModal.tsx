...
const EditPostModal = ({ isOpen, onClose, post, onPostUpdated }: EditPostModalProps) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto" dir="rtl">
                ...
                <div className="flex items-center justify-between p-6 border-b">
                    <h2 className="text-2xl font-bold text-gray-900">تعديل المنشور</h2>
                    <button
                        onClick={onClose}
